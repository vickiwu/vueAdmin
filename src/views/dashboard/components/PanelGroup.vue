  ...
  >
    ...
    >
      <div class="box-card">
        ...
        <div class="card-detail  no1">
          <span>查看更多</span>
          <svg-icon
            icon-class="youjiantou"
