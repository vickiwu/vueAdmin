  ...
  methods: {
    ...
    initCheckedData() {
      if (this.multiple) {
        ...
        //   this.selectedData = this.checkedName
    ...
    popoverHide() {
      ...
      this.$emit("popoverHide", this.checkedIds);
    },
    ...
    handleNodeClick(data, node) {
      if (!this.multiple) {
        ...
        this.$emit("change", this.selectedData, this.dataIndexs);
    ...
    changeSelectedNodes(selectedData) {
      ...
      this.$emit("change", this.selectedData, this.indexXB);
      console.log("changeSelectedNodes");
    },
  },
  watch: {
    isShowSelect(val) {
